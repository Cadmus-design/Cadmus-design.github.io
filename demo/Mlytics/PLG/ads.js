...
function initDesktopAutoplayExample () {
  ...
  adPauseButton = document.getElementById('adPauseButton')
  adPauseButton.addEventListener('click', () => {
    adsManager.pause()
  })
...
function autoplayChecksResolved () {
  ...
  adsRequest.adTagUrl = 'https://staging.onead.com.tw/gos/vast/1000135?dedicated_pid=1433660'
